...
private:
	...
	gfx_bytemap_data _bytemap { static_cast< size_t >( 0 ) };
...
public:
	...
	virtual void set_pixel( gfx_xy_t x, gfx_xy_t y, gfx_color_rgb_8 color ) override;
	virtual void set_pixel( gfx_point point, gfx_color_rgb_8 color ) override;
